...
x <- ggplot(data = dat, aes(x = x, y = y, color = id)) +
  ...
  scale_color_gradient(low = "#addd8e", high = "#11673A", guide = "none") +
  theme_void() +
  coord_fixed() +
...
save_animation(y, "christmas_tree.gif")

#Fonte
#https://github.com/pbiecek/TechnikiWizualizacjiDanych2018/tree/master/PraceDomowe/PD8/gr2/Dominik_Rafacz_PD8